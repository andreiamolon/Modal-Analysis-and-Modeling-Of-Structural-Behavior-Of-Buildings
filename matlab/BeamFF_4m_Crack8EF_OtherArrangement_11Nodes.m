...
ma = rho*A;         Iz=133e-6;            nelem = 10;         ndof = 66;           
% Boundary conditions
bc=[1 2 3 4 5 6 10 16 22 28 34 40 46  52 58 61 62 63 64 65 66]';
...
% ------ list of coordinates  -----------------------------------
Coord=[0  0  0 ; 0.4 0 0; 0.8  0  0 ; 1.2 0 0; 1.6 0 0 ; 
    2.0 0 0 ; 2.4 0 0 ; 2.8 0 0; 3.2 0 0; 3.6 0 0; 4 0 0; 
	   ];
