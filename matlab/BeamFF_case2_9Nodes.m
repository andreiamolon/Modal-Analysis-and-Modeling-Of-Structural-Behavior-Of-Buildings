...
% 
        ...
        % laboratorio para calcular os fixity factors.
                ...
                err1=(sqrt(((f1obj-Freq1)^2) / f1obj^2 +((f2obj-Freq2)^2) / f2obj^2 + ((f3obj-Freq3)^2) / f3obj^2 + ((f4obj-Freq4)^2) / f4obj^2 + ((f5obj-Freq5)^2) / f5obj^2 + ((f6obj-Freq6)^2) / f6obj^2))/6;
                if (err1<err)
                    f1opt=Freq1; 
                    f2opt=Freq2;
                    f3opt=Freq3;  
 ...
 error = err1/sqrt(Freq1^2+Freq2^2+Freq3^2+Freq4^2+Freq5^2+Freq6^2)*6;
